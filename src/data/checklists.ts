// Checklists padrão por modelo de negócio.
//
// Conteúdo de referência: idêntico para toda imobiliária e alterado por
// deploy, não pelo painel. Por isso segue em código, fora do Postgres.
